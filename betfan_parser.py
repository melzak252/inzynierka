...
def looks_like_league(line: str) -> bool:
    ...
    non_lol_keywords = [
        "call of duty", "valorant", "vct", "cct", "united21", "counter strike", 
        "cs2", "cs:go", "dota", "starcraft", "rainbow six", "rocket league",
        "overwatch", "fifa", "nba", "nhl", "nodwin", "european pro league"
    ]
    for kw in non_lol_keywords:
        if kw in line_lower:
            return False
