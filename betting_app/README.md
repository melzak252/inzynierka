...
5. **UI / operacja**
   ...
   - Widok ENC 2027 wybiera najwyższy rating GL wyłącznie z zawodników przypisanych do roli w opublikowanej tabeli kadry Fandom; zawodnik bez aktualnego wpisu GL dostaje jawnie oznaczony rating domyślny 1500.0, czyli baseline Glicko-2. Nie jest to predykcja modelu EXP-039 ani sygnał bukmacherski.
